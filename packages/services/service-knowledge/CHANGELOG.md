...
- 8422acd: fix(service-knowledge): put the test layer in front of tsc, and repair the four defects it was hiding (#15049)
...
- 44106d9: 知识索引在保留期回收(reap)删除行之前先去索引,不再留下孤儿条目(#4672)。
