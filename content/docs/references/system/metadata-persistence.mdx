...
| **projectId** | `string` | optional | Deprecated (ADR-0006 v4): legacy project_id column. New writes leave unset. |
...
| **projectId** | `string` | optional | Deprecated (ADR-0006 v4): legacy project_id column. New code must use organization_id only. |
