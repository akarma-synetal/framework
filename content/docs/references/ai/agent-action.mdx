...
```typescript
import { AgentActionResult, AgentActionSequenceResult, ComponentActionParams, ComponentActionType, ComponentAgentAction, DataActionParams, DataActionType, DataAgentAction, FormActionParams, FormActionType, FormAgentAction, NavigationActionParams, NavigationActionType, NavigationAgentAction, UIActionType, ViewActionParams, ViewActionType, ViewAgentAction, WorkflowActionType } from '@objectstack/spec/ai';
import type { AgentActionResult, AgentActionSequenceResult, ComponentActionParams, ComponentActionType, ComponentAgentAction, DataActionParams, DataActionType, DataAgentAction, FormActionParams, FormActionType, FormAgentAction, NavigationActionParams, NavigationActionType, NavigationAgentAction, UIActionType, ViewActionParams, ViewActionType, ViewAgentAction, WorkflowActionType } from '@objectstack/spec/ai';

// Validate data
const result = AgentActionResult.parse(data);
```
