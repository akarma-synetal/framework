...
```typescript
import { AIOrchestrationExecutionResult, AIOrchestrationTrigger, AITaskType, AgentCommunicationProtocol, AgentGroupMember, AgentGroupRole, BatchAIOrchestrationExecution, MultiAgentGroup, WorkflowFieldCondition } from '@objectstack/spec/ai';
import type { AIOrchestrationExecutionResult, AIOrchestrationTrigger, AITaskType, AgentCommunicationProtocol, AgentGroupMember, AgentGroupRole, BatchAIOrchestrationExecution, MultiAgentGroup, WorkflowFieldCondition } from '@objectstack/spec/ai';
