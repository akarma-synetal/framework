...
- af44044: fix(showcase): put the remaining eight authored validation messages on the translation channel (#14518)
...
- Updated dependencies [709ce17]
- Updated dependencies [fc15f0a]
...
- 6cca75c: Fix the showcase react pages' `useAdapter()` query contract, and pin it (#10288)
...
- Updated dependencies [2810695]
  ...
  - @objectstack/connector-slack@17.2.0
